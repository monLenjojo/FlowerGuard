...
//    public ChaosMath(double x1, double x2, double x3, double y1, double y2, double y3) {
//        this.x1 = x1;
//        this.x2 = x2;
//        this.x3 = x3;
//        this.y1 = y1;
...
//    }
    ...
    public double sub(double v1, double v2) {
        ...
        return b1.setScale(10, 0).subtract(b2.setScale(10, 0)).doubleValue();
    }
...
//        if (sub(x1s,y1s)==0) {
//            Log.d("Math", "x1s： " + x1s + "  y1s： " + y1s + " testTime ：" + testTime + " ");
//        } else {
//            Log.d("Math", "x1s： " + x1s + "  y1s： " + y1s + " testTime ：" + testTime + " ****");
//        }
//    }
